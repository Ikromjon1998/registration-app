...
class ApprenticeshipController extends Controller
{
    public function store(Request $request, Applicant $applicant): JsonResponse
    {
        ...
        $apprenticeship = new Apprenticeship($validatedApprenticeship);
    ...
    public function update(Request $request, Applicant $applicant, Apprenticeship $apprenticeship): JsonResponse
    {
